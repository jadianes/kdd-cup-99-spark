...
def clustering_score(data, k):
    ...
    return (k, clusters, data.map(lambda datum: dist_to_centroid(datum, clusters)).mean())
...
if __name__ == "__main__":
    ...
    print "Calculate scores for different k values (10 to 50)"
    scores = map(lambda k: clustering_score(parsed_data_values, k), range(10,101,10))
